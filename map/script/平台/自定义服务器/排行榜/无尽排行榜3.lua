...
class.dpwj_panel = extends(class.panel){
    create = function()
        --创建底层面板 x,y,width,height
        local panel = class.panel.create('image\\提示框\\bj2.tga',170+400+400+30+30,200,400,620)
        panel.__index = class.dpwj_panel 
...
ac.wait(10,function ()
    panel = class.dpwj_panel.get_instance()
end)
