...
mt.skills = {
    '游戏说明','礼包','称号','武器','翅膀','神圣领域','英雄','武林大会','精彩活动'
} 
-- '全服奖励','赛季奖励'
...
mt.skills = {
    '群号礼包','五星好评礼包','金币礼包','木材礼包','赞助','首充','寻宝小飞侠','神仙水','神装大礼包','神技大礼包','百变英雄礼包'
}
...
mt.skills = {
    '霸王莲龙锤','惊虹奔雷剑','幻海雪饮剑','紫色哀伤','飞星雷火剑','皇帝剑','皇帝刀'
}
-- '霜之哀伤','灭神紫霄剑','方天画戟','圣神无双剑',
...
mt.skills = {
    '梦蝶仙翼','天罡苍羽翼','白龙凝酥翼','白羽金虹翼','玄羽绣云翼','绝世阳炎翼','轮迴幻魔翼'
}
-- '龙吟双形翼','天使之光','金鳞双型翼','赤魔双形翼',
...
mt.skills = {
    '炉火纯青','势不可挡','毁天灭地','风驰电掣','君临天下','无双魅影','神帝','傲世天下','独孤求败'
}
-- '真龙天子','称号-下一页'
...
mt.skills = {
    '血雾领域','龙腾领域','飞沙热浪领域','灵霄烟涛领域','赤霞万象领域','孤风青龙领域','远影苍龙领域'
}
-- '烈火金焰领域','神圣领域-下一页','白云四海领域','烈火天翔领域'
