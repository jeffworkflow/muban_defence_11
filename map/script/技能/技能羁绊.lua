...
mt{
    ...
    on_add_tip = [[]],
    --发送给全部玩家的tip
    send_tip =[[|cffffe799【系统消息】|r 恭喜获得隐藏羁绊技能|cffff0000 "为爆炸而生" |r，|cff00ff00暴击/技暴/会心几率+10%,暴击/技暴/会心加深+100%|r]],
}
...
mt{
    ...
    on_add_tip = [[]],
    --发送给全部玩家的tip
    send_tip =[[|cffffe799【系统消息】|r 恭喜获得隐藏羁绊技能|cffff0000 "铁甲依然在" |r，|cff00ff00护甲+25%，杀怪/攻击/每秒加护甲+1|r]],
}
