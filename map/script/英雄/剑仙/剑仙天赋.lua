...
mt{
  ...
  return ((self.owner:get('力量')+self.owner:get('智力')+self.owner:get('敏捷'))*60+10000)* self.level
end,
	--属性加成
 ['杀怪加全属性'] = {888,1776,2664,3552,4440},
 ['免伤'] = 50,
 ['全伤加深'] = 200,
 ['攻击减甲'] = 250,
 ['对BOSS额外伤害'] = 50,
	--介绍
	tip = [[|cffffff00【杀怪加全属性】+888*Lv
【免伤】+50%
【全伤加深】+200%
【攻击减甲】+250
【对BOSS额外伤害】+50%|r
